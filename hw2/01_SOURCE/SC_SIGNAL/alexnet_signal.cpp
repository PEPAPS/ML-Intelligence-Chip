...
int sc_main(int argc, char *argv[])
{
    ...
    sc_signal<bool> pad_out_valid_sig;
    sc_signal<bool> conv1_out_valid_sig;
    sc_signal<bool> relu1_out_valid_sig;
    sc_signal<bool> pool1_out_valid_sig;
    sc_signal<bool> conv2_out_valid_sig;
    sc_signal<bool> relu2_out_valid_sig;
    sc_signal<bool> pool2_out_valid_sig;
    sc_signal<bool> conv3_out_valid_sig;
    sc_signal<bool> relu3_out_valid_sig;
    sc_signal<bool> conv4_out_valid_sig;
    sc_signal<bool> relu4_out_valid_sig;
    sc_signal<bool> conv5_out_valid_sig;
    sc_signal<bool> relu5_out_valid_sig;
    sc_signal<bool> pool5_out_valid_sig;

    sc_signal<bool> fc6_out_valid_sig;
    sc_signal<bool> relu6_out_valid_sig;
    sc_signal<bool> fc7_out_valid_sig;
    sc_signal<bool> relu7_out_valid_sig;
    sc_signal<bool> fc8_out_valid_sig;
    sc_signal<bool> softmax_out_valid_sig;
    ...
    const int POOL5_OUT_SIZE = 256 * 6  * 6;   // 9216
    ...
    // data signals
    sc_signal<double>* img_sig     = new sc_signal<double>[IMG_SIZE];
    sc_signal<double>* padded_sig  = new sc_signal<double>[PAD_SIZE];

    sc_signal<double>* conv1_sig   = new sc_signal<double>[CONV1_OUT_SIZE];
    sc_signal<double>* relu1_sig   = new sc_signal<double>[CONV1_OUT_SIZE];
    sc_signal<double>* pool1_sig   = new sc_signal<double>[POOL1_OUT_SIZE];

    sc_signal<double>* conv2_sig   = new sc_signal<double>[CONV2_OUT_SIZE];
    sc_signal<double>* relu2_sig   = new sc_signal<double>[CONV2_OUT_SIZE];
    sc_signal<double>* pool2_sig   = new sc_signal<double>[POOL2_OUT_SIZE];

    sc_signal<double>* conv3_sig   = new sc_signal<double>[CONV3_OUT_SIZE];
    sc_signal<double>* relu3_sig   = new sc_signal<double>[CONV3_OUT_SIZE];

    sc_signal<double>* conv4_sig   = new sc_signal<double>[CONV4_OUT_SIZE];
    sc_signal<double>* relu4_sig   = new sc_signal<double>[CONV4_OUT_SIZE];

    sc_signal<double>* conv5_sig   = new sc_signal<double>[CONV5_OUT_SIZE];
    sc_signal<double>* relu5_sig   = new sc_signal<double>[CONV5_OUT_SIZE];
    sc_signal<double>* pool5_sig   = new sc_signal<double>[POOL5_OUT_SIZE];

    sc_signal<double>* fc6_sig     = new sc_signal<double>[FC6_OUT_SIZE];
    sc_signal<double>* relu6_sig   = new sc_signal<double>[FC6_OUT_SIZE];

    sc_signal<double>* fc7_sig     = new sc_signal<double>[FC7_OUT_SIZE];
    sc_signal<double>* relu7_sig   = new sc_signal<double>[FC7_OUT_SIZE];

    sc_signal<double>* fc8_sig     = new sc_signal<double>[FC8_OUT_SIZE];
    sc_signal<double>* softmax_sig = new sc_signal<double>[FC8_OUT_SIZE];
